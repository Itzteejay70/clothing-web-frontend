    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link
            to="/"
            className="text-2xl font-black tracking-tight text-gray-900 hover:text-gray-700 transition-colors"
            aria-label="Home"
          >
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="w-10 h-10 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 flex items-center justify-center transition-all duration-200"
            ...
            {showCart && (
              <Link
                to="/cart"
                className="relative w-10 h-10 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 flex items-center justify-center transition-all duration-200"
                aria-label="Cart"
              >
            ...
            {/* Mobile Menu Button */}
            <button
              className="md:hidden w-10 h-10 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 flex items-center justify-center transition-all duration-200"
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-gray-100">
          ...
          <button
            className="w-10 h-10 rounded-xl border border-gray-200 hover:bg-gray-50 flex items-center justify-center transition-all duration-200"
            onClick={() => setOpen(false)}
        ...
        <nav className="flex flex-col">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `px-4 py-4 font-bold border-b border-gray-50 transition-all duration-200 ${
                isActive
                  ? "bg-green-50 text-green-700"
